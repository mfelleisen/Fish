...
- the tiles: the tiles display between 1 and F fish a tile

- the penguins: every player receives 6 - #players "penguins"
...
- once the players have placed all their penguins, the youngest player executes a move:
  ...
  - the removed tile becomes a property of the player
...
- this continues until all players have placed all their penguins
